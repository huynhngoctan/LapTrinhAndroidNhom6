...
public class Custom_Adapter_list_infor extends BaseAdapter {
    private ArrayList<ItemOfListOrder> listOrder;
    private Activity activity;

    public Custom_Adapter_list_infor(ArrayList<ItemOfListOrder> listOrder, Activity activity) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = inflater.inflate(R.layout.item_order_confirm, null);
        TextView name,price;
        ImageView img;
